  ...
  return (
    <div className="fixed inset-0 bg-overlay flex items-center justify-center z-50 animate-fadeIn">
      <div className="bg-theme-secondary rounded-lg p-6 w-full max-w-md mx-4 animate-slideIn transition-colors border border-theme">
        <h3 className="text-lg font-semibold mb-4 text-theme-primary">プロフィール設定</h3>
        ...
        <div className="mb-4">
          ...
          <input
            ...
            maxLength={50}
            className="w-full px-3 py-2 border border-theme rounded-md bg-theme-primary text-theme-primary focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
          />
        </div>
